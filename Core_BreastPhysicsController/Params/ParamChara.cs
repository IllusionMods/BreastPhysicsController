...
#else
        [IgnoreMember]
        private static readonly ChaFileDefine.CoordinateType[] Coordinates = {
            ChaFileDefine.CoordinateType.Plain,
            ChaFileDefine.CoordinateType.Swim,
            ChaFileDefine.CoordinateType.Pajamas,
...
#endif
        [IgnoreMember]
        private static readonly ParamCharaController.ParamsKind[] WearStates = { ParamCharaController.ParamsKind.Bra, ParamCharaController.ParamsKind.Tops };
